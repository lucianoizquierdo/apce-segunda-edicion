...
<link rel="stylesheet" href="CSS/displaytag.css" type="text/css" media="screen" title="default" />
<!--[if IE]>
...
<body> 
  ...
  <h1> 
  <display:table uid="materiaPrima" name="materiasPrimasList" defaultsort="1" 
    defaultorder="ascending" pagesize="10" id="displaytag"  style="TABLA">
    <display:column property="codigoMateriaPrima" sortable="true" title="ID MateriaPrima"
        maxLength="25" />
    <display:column property="descripcion" sortable="false" title="Descripcion"
        maxLength="25" />
    <display:column property="color" sortable="false"
        title="Color" maxLength="25"  />
    <display:column property="kilos" sortable="false" title="Kilos"
        maxLength="25" />
     <display:setProperty name="paging.banner.group_size" value="10" />
      <display:setProperty name="paging.banner.item_name" value="materiaPrima" />  
